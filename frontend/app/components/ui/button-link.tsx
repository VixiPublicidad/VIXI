...
const variantClasses: Record<NonNullable<ButtonLinkProps["variant"]>, string> = {
  primary:
    "bg-accent-400 text-brand-950 shadow-[0_18px_40px_rgba(244,166,183,0.35)] hover:bg-accent-300",
  secondary:
    "border border-brand-950/12 bg-white/80 text-brand-950 hover:border-brand-950/25 hover:bg-white",
