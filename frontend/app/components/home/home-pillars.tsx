  ...
  return (
    <section className="mx-auto grid max-w-[80vw] gap-8 py-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
      <div className="rounded-[32px] bg-brand-950 p-8 text-white shadow-[0_22px_60px_rgba(11,31,59,0.18)]">
        <p className="eyebrow-label text-accent-200">Pilares de marca</p>
      ...
      <div className="grid gap-5 md:grid-cols-3">
        <article className="flex flex-col rounded-[32px] border border-brand-950/8 bg-white/84 p-8 shadow-[0_18px_50px_rgba(11,31,59,0.07)] backdrop-blur-sm md:col-span-3">
        ...
        {brandPillars.map((pillar) => (
          ...
          >
            ...
            <div className="relative z-10 flex flex-col justify-end p-6 sm:p-7">
              <p className="eyebrow-label text-[10px] text-accent-200">Pilares de marca</p>
