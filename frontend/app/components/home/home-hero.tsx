...
export function HomeHero() {
  return (
    <PageHero
      actions={homeActions}
      description="VIXI es una clínica especializada en fertilización asistida que combina tecnología avanzada, trato cercano y decisiones clínicas individualizadas dentro de un entorno hospitalario de prestigio. Con 12 años de experiencia en la especialidad."
