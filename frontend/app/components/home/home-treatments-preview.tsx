  ...
  return (
    <section className="mx-auto max-w-[80vw] py-16 lg:px-8">
      <div className="grid max-w-5xl gap-6 sm:grid-cols-[auto_1fr] md:gap-10">
        ...
        <div>
          <p className="eyebrow-label mb-4 text-[10px] text-brand-700">Tratamientos</p>
          <h2 className="display-balance font-display text-4xl leading-[0.96] tracking-[-0.05em] text-brand-950 sm:text-5xl lg:text-6xl">
            Un portafolio clínico pensado para decisiones bien informadas
          </h2>
          <p className="mt-6 max-w-3xl pr-4 text-base leading-8 text-brand-950/74 sm:ml-4 sm:text-lg">
            Desde evaluación y el diagnóstico hasta técnicas de reproducción asistida, preservación de fertilidad y donación.
          </p>
        </div>
      </div>
      <div className="mt-10 grid gap-5 lg:grid-cols-3">
        <article className="group flex flex-col rounded-[30px] border border-brand-950/8 bg-white/82 p-7 shadow-[0_20px_50px_rgba(11,31,59,0.07)] backdrop-blur-sm transition-all hover:-translate-y-1 hover:shadow-[0_24px_60px_rgba(11,31,59,0.11)]">
          <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-[18px] bg-brand-950/[0.04] text-brand-700 transition-colors group-hover:bg-brand-950/[0.06]">
            <FaMicroscope aria-hidden="true" className="h-6 w-6" />
          </div>
        ...
        <article className="group flex flex-col rounded-[30px] border border-brand-950/8 bg-white/82 p-7 shadow-[0_20px_50px_rgba(11,31,59,0.07)] backdrop-blur-sm transition-all hover:-translate-y-1 hover:shadow-[0_24px_60px_rgba(11,31,59,0.11)]">
          <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-[18px] bg-brand-950/[0.04] text-brand-700 transition-colors group-hover:bg-brand-950/[0.06]">
            <FaDna aria-hidden="true" className="h-6 w-6" />
          </div>
          <h3 className="font-display text-[1.65rem] leading-[1.02] tracking-[-0.035em] text-brand-950">
        ...
        <article className="group flex flex-col rounded-[30px] border border-brand-950/8 bg-white/82 p-7 shadow-[0_20px_50px_rgba(11,31,59,0.07)] backdrop-blur-sm transition-all hover:-translate-y-1 hover:shadow-[0_24px_60px_rgba(11,31,59,0.11)]">
          <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-[18px] bg-brand-950/[0.04] text-brand-700 transition-colors group-hover:bg-brand-950/[0.06]">
            <FaSnowflake aria-hidden="true" className="h-6 w-6" />
          </div>
          <h3 className="font-display text-[1.65rem] leading-[1.02] tracking-[-0.035em] text-brand-950">
