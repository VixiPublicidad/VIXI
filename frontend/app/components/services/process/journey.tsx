...
import { useProcessJourneyAnimation } from "./use-process-journey-animation";

export function ProcessJourney() {
  const containerRef = useRef<HTMLElement>(null);

  useProcessJourneyAnimation(containerRef);
      ...
      <div className="mt-8 grid gap-5">
        {treatmentJourney.map((item) => (
          ...
          >
            ...
            <div data-process-journey-content>
